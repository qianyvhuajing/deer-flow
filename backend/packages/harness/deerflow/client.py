...
class DeerFlowClient:
    ...
    def _ensure_agent(self, config: RunnableConfig):
        ...
        kwargs: dict[str, Any] = {
            ...
            "tools": self._get_tools(model_name=model_name, subagent_enabled=subagent_enabled, agent_name=self._agent_name),
    ...
    @staticmethod
    def _get_tools(*, model_name: str | None, subagent_enabled: bool, agent_name: str | None = None):
